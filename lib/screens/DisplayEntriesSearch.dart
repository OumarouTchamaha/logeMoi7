...
class DisplayEntriesRecherche extends StatefulWidget {
  final String quartier;


  DisplayEntriesRecherche({this.quartier});

  @override
  _DisplayEntriesRechercheState createState() => _DisplayEntriesRechercheState();
}
...
class _DisplayEntriesRechercheState extends State<DisplayEntriesRecherche> {
  @override
                            ...
                            Container(
                              ...
                              child: StreamBuilder<QuerySnapshot>(
                                stream: databaseReference
                                    .limit(20)
                                    .where('quartier', isEqualTo: widget.quartier)
                                    .orderBy('date_ajout', descending: true)
                                    .snapshots(),
                                builder: (BuildContext context,
                                    AsyncSnapshot<QuerySnapshot> snapshot) {
                                  if (snapshot.hasError)
                                    return new Text('Erreur Inconnue');
                                  if (!snapshot.hasData) {
                                    return Center(
