...
//                  Padding(
//                    padding:
//                    EdgeInsets.only(left: 10.0, right: 10.0, bottom: 30.0, top: 10.0),
//                    child:  Column(
//                      children: <Widget>[
//                        Padding(
//                          padding: EdgeInsets.only(left: 10.0, right: 10.0, bottom: 0.0, top: 10.0),
//                          child: Text(
//                            "Information",
//                            style: TextStyle(
//                                color: primaryColor,
...
//                        Container(
//                          child: Padding(
//                            padding: EdgeInsets.only(top: 15.0, left: 20.0, right: 20.0, bottom: 25.0),
//                            child: Divider(
//                              thickness: 1,
//                              height: 2,
//                            ),
...
//                                labelText: "Type",
//                                autofocus : false,
//                                hintText: "ex: Chambre, Appartement, Studio, Maison",
//                                validate: (input) {
//                                  if (input.isEmpty) {
//                                    return 'Le type ne peux pas être vide';
//                                  }else{
...
//                                          child: _imageSalon !=null ? Text(_imageSalon.path,
//                                              textAlign: TextAlign.start,
//                                              style: TextStyle(
//                                                  fontSize: 12,
...
//                                          onPressed: chooseFileSalon,
//                                          tooltip: 'Pick Image',
//                                          child: Icon(Icons.add_a_photo, size: 17, color: white,),
//                                        )
//                                    ),
//                                  ],
//                                )
...
//                                        Padding(
//                                          padding: EdgeInsets.symmetric(horizontal: 17, vertical: 12),
//                                          child: _imageCuisine !=null ? Text(_imageCuisine.path,
//                                              textAlign: TextAlign.start,
//                                              style: TextStyle(
//                                                  fontSize: 12,
//                                                  fontStyle: FontStyle.italic,
...
//                                        Padding(
//                                          padding: EdgeInsets.symmetric(horizontal: 17, vertical: 12),
//                                          child: _imageChambre !=null ? Text(_imageChambre.path,
//                                              textAlign: TextAlign.start,
//                                              style: TextStyle(
//                                                  fontSize: 12,
//                                                  fontStyle: FontStyle.italic,
...
//                                        Padding(
//                                          padding: EdgeInsets.symmetric(horizontal: 17, vertical: 12),
//                                          child: _imageDouche !=null ? Text(_imageDouche.path,
//                                              textAlign: TextAlign.start,
//                                              style: TextStyle(
//                                                  fontSize: 12,
//                                                  fontStyle: FontStyle.italic,
...
//                                      Padding(
//                                        padding: EdgeInsets.symmetric(horizontal: 17, vertical: 12),
//                                        child: _image !=null ? Text(_image.path,
//                                            textAlign: TextAlign.start,
//                                            style: TextStyle(
//                                                fontSize: 12,
//                                                fontStyle: FontStyle.italic,
...
//          )),
  ...
  Future setDataFields() async {
    ...
    if (formState.validate()) {
      ...
      print(_doucheDescription);
      print(_chambreDescription);
      print(_cuisineDescription);
      print(_salonDescription);
      print(_salon);
      try {
